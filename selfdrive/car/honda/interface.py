...
class CarInterface(CarInterfaceBase):
  ...
  def _get_params(ret, candidate, fingerprint, car_fw, experimental_long, docs):
    ...
    if candidate == CAR.CIVIC:
      ...
      ret.steerRatio = 19.33  # 10.93 is end-to-end spec
      if eps_modified:
      ...
      ret.steerRatio = 21.33  # 11.82 is spec end-to-end
      ret.lateralParams.torqueBP, ret.lateralParams.torqueV = [[0, 4096], [0, 4096]]  # TODO: determine if there is a dead zone at the top end
      ...
      ret.steerRatio = 19.33  # 15.3 is spec end-to-end
      ...
      ret.wheelbase = 2.66
      ret.centerToFront = ret.wheelbase * 0.41
      ret.steerRatio = 19.33  # 12.3 is spec end-to-end
      if eps_modified:
      ...
      ret.wheelbase = 2.75
      ret.centerToFront = ret.wheelbase * 0.39
      ret.steerRatio = 19.33 # 13.37 is spec
      ...
      ret.wheelbase = 2.7
      ret.centerToFront = ret.wheelbase * 0.39
      ret.steerRatio = 19.33  # 12.58 is spec end-to-end
      ret.lateralParams.torqueBP, ret.lateralParams.torqueV = [[0, 4096], [0, 4096]]  # TODO: determine if there is a dead zone at the top end
      ret.tireStiffnessFactor = 0.82
      ret.lateralTuning.pid.kpV, ret.lateralTuning.pid.kiV = [[0.6], [0.18]]
      ...
      ret.wheelbase = 2.75
      ret.centerToFront = ret.wheelbase * 0.4
      ret.steerRatio = 19.33  # 12.72 is end-to-end spec
      if eps_modified:
        for fw in car_fw:
